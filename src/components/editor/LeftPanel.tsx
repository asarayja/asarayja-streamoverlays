...
const DECOR_PRESETS: Array<{ label: string; patch: LayerPatch; type?: LayerType }> = [
  ...
  { label: "Pumpkin", patch: { shape: "pumpkin", x: 760, y: 360, width: 340, height: 300, fill: "@accent", effects: { ...DEFAULT_EFFECTS, glow: { enabled: true, color: "@glow", strength: 24 }, border: { enabled: true, color: "@shadow", width: 4, radius: 0 } } } },
...
const DECOR_GROUP: Record<string, DecorCategory> = {
  ...
  "Graveyard": "Gothic", "Drip panel": "Gothic", "Plaque": "Gothic", "Harlequin": "Gothic", "Pumpkin": "Gothic",
  ...
  return (
    <div>
      ...
      <div className="border-t border-white/[0.06] px-4 py-4">
        ...
        <p className="mb-3 text-[11px] leading-relaxed text-zinc-600">
          {showIconLib
            ? t("Thousands of Lucide, Font Awesome & Phosphor (incl. duotone) icons — search, then click to place. Each takes its colour from a theme token.")
